...
do -- [[ Animations ]] --
	...
	Animations:MakeButton("Conga", function()
		PlayAnimation(4572096542)
	end)
	Animations:MakeButton("Dream Feet", function()
		PlayAnimation(4300218011)
	end)
	...
	Animations:MakeButton("Take The L", function()
		PlayAnimation(4827299133)
	end)
	Animations:MakeButton("Laughing", function()
		PlayAnimation(4846000379)
	end)
	Animations:MakeButton("Drip", function()
		PlayAnimation(4959380041)
	end)
	Animations:MakeButton("Pushups", function()
		PlayAnimation(4966881089)
	end)
	Animations:MakeButton("California Girls (Laggy)", function()
		PlayAnimation(12219303048)
	end)
	Animations:MakeButton("Sit", function()
		PlayAnimation(12219493800)
	end)
	Animations:MakeButton("Sit - Lean", function()
		PlayAnimation(12219487128)
	end)
	Animations:MakeButton("Lay", function()
		PlayAnimation(12219490165)
	end)
	Animations:MakeButton("Death", function()
	    PlayAnimation(12333567131)
	end)
	Animations:MakeButton("", function()
	end)
	Animations:MakeButton("MORE ANIMS", function()
	end)
	Animations:MakeButton("[HERE] - [UNCLOSABLE]", function()
	    loadstring(game:HttpGet("https://raw.githubusercontent.com/muiky05/randomeditedscripts/main/AnimGui.lua"))()
	end)
end
...
do -- [[ Scripts ]] --
	...
	HatScripts:MakeButton("The Hotline", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/TheHotline.lua"))()
	end)
	HatScripts:MakeButton("Attack Rifle", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/AttackRifle.lua"))()
	end)
	HatScripts:MakeButton("Carnage", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/TheCarnage.lua"))()
	end)
	HatScripts:MakeButton("Zenith Battle Rifle-70", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/ZenithAttackRifle.lua"))()
	end)
	HatScripts:MakeButton("Chips", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/TheChips.lua"))()
	end)
	HatScripts:MakeButton("Void Scythe", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/VoidScythe.lua"))()
	end)
	HatScripts:MakeButton("Blue-Black Sniper", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/TheSniper.lua"))()
	end)
	HatScripts:MakeButton("Banzai Bazooka", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/BanzaiBazooka.lua"))()
	end)
	HatScripts:MakeButton("Voodoo Doll", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/VoodooDoll.lua"))()
	end)
	HatScripts:MakeButton("Quenox", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/Quenox.lua"))()
	end)
	HatScripts:MakeButton("Goner", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/Goner.lua"))()
	end)
	HatScripts:MakeButton("[BUGS] Lightning Cannon V4", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/LightningCannon.lua"))()
	end)
	
	FreeScripts:MakeButton("Gale Fighter", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/GaleFighter.lua"))()
	end)
	FreeScripts:MakeButton("Ender.", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/Ender.lua"))()
	end)
	FreeScripts:MakeButton("Cadacus.", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/toldblock/GelatekHub/main/src/scripts/Cadacus.lua"))()
	end)
end
...
do -- [[ Credits ]] --
	Credits:MakeLabel("Gui: Gelatek - Revamp by Ernad")
