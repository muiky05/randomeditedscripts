...
local HatAlt = Character:FindFirstChild("Black Demon Trident")
...
if Hat then
	...
	table.insert(Events, game:GetService("RunService").PostSimulation:Connect(function()
		Hat.Handle.CFrame = weaponweld.Parent.CFrame * CFrame.new(-2.6, 0, 0) * CFrame.Angles(math.rad(2),0,math.rad(-90))
...
if HatAlt then
	...
	table.insert(Events, game:GetService("RunService").PostSimulation:Connect(function()
		HatAlt.Handle.CFrame = weaponweld.Parent.CFrame * CFrame.new(-1.2, 0.2, 0) * CFrame.Angles(0,0,math.rad(45))
